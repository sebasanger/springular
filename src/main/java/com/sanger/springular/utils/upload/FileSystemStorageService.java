 ...
 * 
 * ESTO SE REALIZA ASÍ PARA NO HACER MÁS COMPLEJO EL EJEMPLO. EN UNA APLICACIÓN
 * EN PRODUCCIÓN POSIBLEMENTE SE UTILICE UN ALMACÉN REMOTO.
 * 
 * 
...
public class FileSystemStorageService implements StorageService {
     ...
     * MultipartFile
     * 
     * Modificamos el original del ejemplo de Spring para cambiar el nombre del
     * fichero a almacenar. Como lo asociamos al Empleado que se ha dado de alta,
     * usaremos el ID de empleado como nombre de fichero.
     * 
     */
    @Override
